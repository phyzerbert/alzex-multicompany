        ...
        <div class="page-header page-header-light">
            <div class="page-header-content header-elements-md-inline">
                <div class="page-title d-flex">
                    <h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">{{__('page.home')}}</span> - {{__('page.company')}}</h4>
            ...
            <div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
                <div class="d-flex">
                    <div class="breadcrumb">
                        ...
                        <span class="breadcrumb-item active">{{__('page.company')}}</span>
                    </div>
                </div>
            </div>
        </div>
                                ...
                                @foreach ($data as $item)
                                    <tr>
                                        ...
                                        <td class="py-1">
                                            ...
                                            <a href="{{route('company.delete', $item->id)}}" class="btn bg-danger text-pink-800 btn-icon rounded-round ml-2" data-popup="tooltip" title="{{__('page.delete')}}" data-placement="top" onclick="return window.confirm('{{__('page.are_you_sure')}}')"><i class="icon-trash"></i></a>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
                ...
                <form action="{{route('company.create')}}" id="create_form" method="post">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <input class="form-control name" type="text" name="name" required placeholder="{{__('page.name')}}">
                        </div>
                        <div class="form-group">
