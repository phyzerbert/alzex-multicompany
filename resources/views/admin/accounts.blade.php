                                ...
                                @foreach ($data as $item)
                                    <tr>
                                        ...
                                        <td class="py-1">
                                            ...
                                            <a href="{{route('account.delete', $item->id)}}" class="btn bg-danger text-pink-800 btn-icon rounded-round ml-2" data-popup="tooltip" title="{{__('page.delete')}}" data-placement="top" onclick="return window.confirm('{{__('page.are_you_sure')}}')"><i class="icon-trash"></i></a>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
                ...
                <form action="{{route('account.create')}}" id="create_form" method="post">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="name" required placeholder="{{__('page.name')}}">
                        </div>
            ...
            <div class="modal-content">
                ...
                <form action="{{route('account.edit')}}" id="edit_form" method="post">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label class="control-label">{{__('page.name')}}</label>
                            <input class="form-control name" type="text" name="name" required placeholder="Name">
                        </div>
                        <div class="form-group">
                            <label class="control-label">{{__('page.company')}}</label>
                            <select class="form-control company_id" name="company" required>
